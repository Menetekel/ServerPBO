...
//Mission start
[nil,nil,rTitleText,"MJ12: An APC has broken down! Secure it's firepower for yourself!", "PLAIN",6] call RE;
[nil,nil,rGlobalRadio,"MJ12: An APC has broken down! Secure it's firepower for yourself!"] call RE;
[nil,nil,rHINT,"MJ12: An APC has broken down! Secure it's firepower for yourself!"] call RE;

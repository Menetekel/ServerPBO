...
//Mission start
[nil,nil,rTitleText,"MJ11: A humvee has broken down! Secure it's firepower for yourself!", "PLAIN",6] call RE;
[nil,nil,rGlobalRadio,"MJ11: A humvee has broken down! Secure it's firepower for yourself!"] call RE;
[nil,nil,rHINT,"MJ11: A humvee has broken down! Secure it's firepower for yourself!"] call RE;

...
//Mission start
[nil,nil,rTitleText,"MJ8: A C-130 has crash landed! Secure it's cargo for yourself!", "PLAIN",6] call RE;
[nil,nil,rGlobalRadio,"MJ8: A C-130 has crash landed! Secure it's cargo for yourself!"] call RE;
[nil,nil,rHINT,"MJ8: A C-130 has crash landed! Secure it's cargo for yourself!"] call RE;

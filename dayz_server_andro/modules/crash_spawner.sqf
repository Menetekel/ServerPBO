...
_guaranteedLoot = 2;                //Guaranteed Loot Spawns
_randomizedLoot = 2;                //Random number of loot piles aswell as the guaranteed ones
_spawnFire      = true;                //Spawn Smoke/Fire at the helicrash
_fadeFire      = false;            //Fade the Smoke/Fire overtime
_preWaypoints    = 9;                //Amount of waypoints the heli flys to before crashing
_crashDamage    = 0.1;                //Amount of dammage the heli can take before crashing (between 0.1 and 1) Lower the number and the heli can take less damage before crashing 1 dammage is fully destroyed and 0.1 something like a DMR could one shot the heli
_heliModel        = "UH1Y_DZE";        //The type of heli used
_crashModel    = "UH1Wreck_DZ";    //The type of Crash model used after the heli crashes
_exploRange    = 5000;                //How far away from the predefined crash point should the heli start crashing
